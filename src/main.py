...
def select_peak() -> Peak:
    ...
    # peak_number = io.prompt_user_for_num(prompt_msg, happy_msg, penetrometer_data.is_valid_peak)
    ...
    if fig_manager.selected_peak_number is not None:
        ...
        selected_peak = Peak(peak_num=fig_manager.selected_peak_number - 1, penetrometer_data=penetrometer_data)
